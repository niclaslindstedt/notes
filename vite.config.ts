  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        // `maskable-icon-1024x1024.png` is generated too but deliberately not
        // listed: it exists only as the desktop shell's packaging source
        // (`electron/electron-builder.config.cjs`), and no browser needs a
        // launcher icon that large.
        icons: [
