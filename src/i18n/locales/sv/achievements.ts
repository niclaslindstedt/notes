...
const achievements: AchievementsCatalog = {
  ...
  catalog: {
    ...
    underLockAndKey: {
      ...
      learnMore:
        "Ögonknappen bredvid stjärnan gör den öppna anteckningen skrivskyddad. En låst anteckning tar inte emot någon markör alls: trycker du i den på en telefon stannar tangentbordet nere, klickar du i den på en dator börjar ingenting blinka — så anteckningen du håller öppen som referens kan inte skrivas i av misstag, eller av fickan. Knapparna som skulle skriva om den följer med markören (formatering, klipp ut och namnfältet), medan allt som bara läser den fungerar precis som förut: du kan skrolla, markera, kopiera, söka, exportera, stjärnmärka och arkivera. Kryssrutorna på uppgiftsrader går fortfarande att trycka på, så en låst checklista kan bockas av medan texten står kvar. Radnummerspalten fungerar också, så ett tryck på ett nummer markerar hela raden och kopieringsknappen glider fram för att ta den. Tryck på ögat igen för att låsa upp. Låset följer med anteckningen, så den är låst på dina andra enheter också.",
    },
