...
const app: AppCatalog = {
  ...
  comments: {
    add: "Kommentera de valda raderna",
    open: "Läs kommentaren på rad {n}",
    title: "Kommentar på rad {lines}",
    titleMany: "Kommentarer på raderna {lines}",
    new: "Skriv en kommentar",
    another: "Lägg till en kommentar till",
    on: "På rad {lines}",
    onMany: "På raderna {lines}",
    edit: "Kommentar",
    placeholder: "Vad behöver sägas här?",
    delete: "Ta bort kommentaren",
    done: "Klar",
    hint: "Kommentarer sparas med anteckningen, aldrig inuti texten.",
  },
  moveLines: {
  ...
  attachmentGone: "”{name}” finns inte lagrad här längre",
  attachmentGoneMany: "{count} bilagor finns inte lagrade här längre",
