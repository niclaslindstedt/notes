      ...
      <article className="mx-auto flex w-full max-w-2xl flex-col gap-8 leading-relaxed">
        ...
        <Section title="What you can do with it">
          <ul className="ml-5 list-disc space-y-1.5">
            ...
            <li>
              Cut text out with the <em>X—</em> button beside the copy button:
              it takes whatever you have selected, or — with nothing selected —
              the whole line the cursor is on, or just the text after it when
              the cursor is parked mid-sentence. What it takes goes on your
              clipboard, ready to paste back somewhere else. <kbd>Ctrl</kbd>/
              <kbd>Cmd</kbd>+<kbd>K</kbd> does the same from the keyboard, and
              Undo puts it back.
            </li>
            <li>
