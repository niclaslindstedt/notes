...
| **Desktop app** / **the Electron wrapper** / **the downloadable app** / **the window** | `electron/main.js` (the whole main process), `electron/electron-builder.config.cjs`, `electron/scripts/bundle-web.mjs`; built by `make build-electron` (`VITE_TARGET=electron` in `vite.config.ts`), packaged by the `desktop` job in `.github/workflows/release.yml`. [→](overview.md#desktop-app-electron) |
