...
| **Undo** / **redo** / **undo timeline** / **history** / **sentence-level undo** / **undo sentence by sentence** | `useUndoRedo`, `UndoRedo`, `UNDO_HISTORY_LIMIT` (`src/app/use-undo-redo.ts`); `sentenceBoundaryCount` (`src/domain/sentence.ts`, the per-sentence merge-key granularity); `useUndoRedoShortcuts` (`src/ui/hooks/useUndoRedoShortcuts.ts`). [→](overview.md#undo--redo) |
