...
| **Self-hosted backend** / **notesd** / **pair a server**   | `createNotesdAdapter` (`src/storage/notesd/index.ts`); `useNotesdBackend`; `parsePairingUri` (`src/storage/notesd/pairing.ts`); the daemon in `notesd/`. [→](overview.md#notesd-backend) |
