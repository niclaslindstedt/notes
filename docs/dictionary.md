...
| **Crash screen** / **error boundary** / **the app went black** / **blank screen** / **"something went wrong"** / **have to restart the app cold** | `ErrorBoundary` (`src/ui/ErrorBoundary.tsx`), wrapped around the shell in `src/app/main.tsx`; the crash is logged under the `crash` scope. [→](overview.md#crash-screen) |
