...
| **Pinned fetch** / **native bridge** / **QR pairing**      | `createPinnedFetch`, `isNative` (`src/platform/native-bridge.ts`); `PairNotesdForm` (`src/ui/settings/StorageSection.tsx`). [→](overview.md#notesd-backend) |
