...
| **Line numbers** / **the gutter** / **the numbers down the left** / **click a line number** / **press a number to select the row** / **gutter width** / **line-number spacing** | `LineRow`, `selectLine`, `selectLineSpan`, `GUTTER_GAP` (`src/ui/MarkdownEditor.tsx`); the `lineNumbers` editor setting (`src/theme/themes.ts`); the **Count the lines** achievement. [→](overview.md#line-numbers) |
